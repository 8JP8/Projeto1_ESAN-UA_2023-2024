...
int sensorPin = P1_0; // Digital pin for photoelectric sensor (alterado para uma entrada digital)
...
void loop() {
  ...
  // Perform a digital output based on the sensor value
  digitalWrite(led1Pin, sensorValue);
}
