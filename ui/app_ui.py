...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon9 = QIcon()
        icon9.addFile(u"../../../Downloads/calibrate.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.detectionmode_COMBOBOX_2.setGeometry(QRect(601, 8, 40, 20))
        ...
        self.colorfilters_BT.setGeometry(QRect(560, 7, 30, 23))
        icon11 = QIcon()
