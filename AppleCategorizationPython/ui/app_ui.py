...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.settingsgroup.setGeometry(QRect(10, 10, 651, 90))
        ...
        self.cam1_RADIOBT.setGeometry(QRect(570, 35, 71, 21))
        ...
        self.cam2_RADIOBT.setGeometry(QRect(570, 55, 81, 21))
        ...
        self.threshold1_SLIDER.setGeometry(QRect(400, 30, 151, 21))
        ...
        self.threshold2_SLIDER.setGeometry(QRect(400, 60, 151, 21))
        ...
        self.detectionmode_COMBOBOX_2 = QComboBox(self.settingsgroup)
        self.detectionmode_COMBOBOX_2.addItem("")
        self.detectionmode_COMBOBOX_2.setObjectName(u"detectionmode_COMBOBOX_2")
        self.detectionmode_COMBOBOX_2.setGeometry(QRect(610, 8, 40, 20))
        ...
        self.colorfilters_BT.setGeometry(QRect(561, 7, 30, 23))
        icon9 = QIcon()
        icon9.addFile(u"icons/colour.ico", QSize(), QIcon.Normal, QIcon.Off)
        self.colorfilters_BT.setIcon(icon9)
        self.start_BT = QPushButton(self.centralwidget)
        self.start_BT.setObjectName(u"start_BT")
        self.start_BT.setGeometry(QRect(670, 49, 91, 51))
        self.upload_BT = QPushButton(self.centralwidget)
        self.upload_BT.setObjectName(u"upload_BT")
        self.upload_BT.setGeometry(QRect(670, 16, 91, 24))
...
"border: 1px solid grey;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.thlb1.setText(QCoreApplication.translate("MainWindow", u"Threshold 1", None))
        self.thlb2.setText(QCoreApplication.translate("MainWindow", u"Threshold 2", None))
        ...
        self.detectionmode_COMBOBOX_2.setItemText(0, QCoreApplication.translate("MainWindow", u"V1", None))

        self.detectionmode_COMBOBOX_2.setCurrentText(QCoreApplication.translate("MainWindow", u"V1", None))
        self.detectionmode_COMBOBOX_2.setProperty("placeholderText", QCoreApplication.translate("MainWindow", u"V1", None))
        ...
        self.colorfilters_BT.setText("")
        self.start_BT.setText(QCoreApplication.translate("MainWindow", u"INICIAR\n"
"(Ctrl+I)", None))
        self.upload_BT.setText(QCoreApplication.translate("MainWindow", u"UPLOAD", None))
