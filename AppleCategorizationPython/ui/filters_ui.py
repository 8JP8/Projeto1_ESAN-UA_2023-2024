...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.output_erode_slider.setMaximum(5)
        ...
        self.output_erode_spinbox.setMaximum(5)
        ...
        self.output_dilate_slider.setMaximum(5)
        ...
        self.output_dilate_spinbox.setMaximum(5)
